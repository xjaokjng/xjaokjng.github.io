	...
	jQuery(document).ready(function($) {
		...
		$('.wpforms-form').each(function(index, element) {
	...
	function wpforms_ajax_submit(form_id) {	
		...
		var overlay = '<div id="'+form_id+'-overlay" style="background-image:url('+wpforms_ajax_submit_data.loading_image+');background-position:center center;background-repeat:no-repeat;width:100%;height:100%;position:absolute;background-color:rgba(0,0,0,0.25);z-index:9999;"></div>';
